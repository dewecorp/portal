    ...
    function renderCanvas() {
        ...
        state.items.forEach(function(s) {
            ...
            card.innerHTML = '<span class="sb-grip" title="Geser untuk pindah">' + (UI.grip || '') + '</span>'
                ...
                + '<span class="sb-nav">'
                + '<button type="button" class="sb-iconbtn" data-act="up" title="Naik"' + (isFirst ? ' disabled' : '') + '>' + (UI.chevU || '') + '</button>'
                + '<button type="button" class="sb-iconbtn" data-act="down" title="Turun"' + (isLast ? ' disabled' : '') + '>' + (UI.chevD || '') + '</button>'
                + '</span>'
